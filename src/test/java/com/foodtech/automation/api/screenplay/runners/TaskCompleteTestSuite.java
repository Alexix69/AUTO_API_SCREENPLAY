...
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@apiOrderNotCompletedWhenTasksRemain or @apiOrderCompletedWhenLastTaskDone or @apiCompleteTaskInPendingReturns409 or @concurrentStartRaceCondition")
...
public class TaskCompleteTestSuite {
}
