...
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@apiAuthCocineroOrders or @apiAuthMeseroBarTasks or @apiAuthMeseroTasks or @apiInvalidRoleRegistration")
