...
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@apiCrossRoleStartForbidden or @apiStartAlreadyInPreparationConflict")
...
public class TaskStartTestSuite {
}
